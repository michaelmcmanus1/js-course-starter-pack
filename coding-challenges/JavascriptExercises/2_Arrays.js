...
treasureChest.push('fur jackets');
...
// 4. What is the length of our array? 1
...
treasureChest[2] = '3rd index value';

console.log(treasureChest.length);
var arrayLength = treasureChest.length;
treasureChest[arrayLength] = 'Always last point';
...
console.log(treasureChest[0],treasureChest[1], treasureChest[2], treasureChest[3]);
// ******** NIGHTMARE MODE! ********* // 
...
treasureChest.unshift('First index');
...
var object2 = {type: 'yeti', collects: 'rocks', canFly: false};
var object3 = {type: 'Loch Ness Monster', collects: 'water', canFly: false};
